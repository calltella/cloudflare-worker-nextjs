/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 5ab1f2886028cae5da42617c0429e7a3)
// Runtime types generated with workerd@1.20260128.0 2025-12-01 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		IMAGES: ImagesBinding;
		ASSETS: Fetcher;
		API_BASE_URL: "https://app.yuichi-asa.workers.dev";
		NEXTJS_ENV: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "API_BASE_URL" | "NEXTJS_ENV">> {}
}
